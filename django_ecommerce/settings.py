...
STRIPE_SECRET = 'sk_test_CpkeBUosDcSomgLCzrA3i4vM'
STRIPE_PUBLISHABLE = 'pk_test_CQvvY7vRLHtBxuQ4oSzGZZn4'
...
#DATABASES = {
    #'default': {
        ...
        #'ENGINE': 'django.db.backends.mysql',
        #'HOST': '/cloudsql/django-webapplication:quinndatabase',
        #'NAME': 'cloudkun',
        #'USER': 'quinn',

        #'ENGINE': 'rocket_engine.db.backends.cloudsql',
        #'INSTANCE': 'django-webapplication',
        #'NAME': 'django-webapplication:quinndatabase',      
    #}
#}
